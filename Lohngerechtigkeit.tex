...
\begin{abstract}
    ...
    Der geschlechtsspezifische Lohnunterschied hat sich in der Schweiz in den letzten zwei Jahrzehnten zwar leicht verringert, aber die Lücke ist immer noch beträchtlich. Im Jahr 2016 verdienten Frauen etwa 20\% weniger als Männer in einem Vollzeitjob in der Privatwirtschaft. Etwa 40\% dieses Unterschieds lassen sich nicht durch Unterschiede in relevanten Faktoren wie Humankapital oder Wirtschaftssektoren erklären. Somit bleibt unklar, ob dieser unerklärte Anteil auf Diskriminierung zurückzuführen ist oder ob die angewandten statistischen Modelle nicht genau genug sind. Um das geschlechtsspezifische Lohngefälle aus einer anderen Perspektive zu beleuchten, haben wir einen alternativen Ansatz gewählt und drei faktorielle Surveys durchgeführt, um festzustellen, ob es ein "just wage gap" zwischen Männern und Frauen gibt. Die Ergebnisse des ersten Experiments belegen eine geschlechtsspezifische Doppelmoral bei der Einkommensbewertung: Die Testpersonen beurteilten ein geringeres Einkommen für Frauen als gerecht.  Das heisst, nach diesen Urteilen sollten Frauen tatsächlich weniger verdienen als Männer. Die Ergebnisse des zweiten Experiments stehen im Gegensatz zu diesen Ergebnissen: Bei ähnlichem Design konnten keine geschlechtsspezifischen Unterschiede im als gerecht beurteilten Einkommen festgestellt werden. Ein Grund für die Differenzen könnte sein, dass der Haushaltskontext in Experimenten nicht konstant gehalten wurde. Deshalb haben wir ein drittes Experiment durchgeführt, bei dem wir systematisch variierten, ob die beschriebenen Personen alleinstehend oder verheiratet waren. Die Ergebnisse zeigen, dass der familiäre Kontext tatsächlich ein wichtiger Mediator ist. Für Singles konnte kein geschlechtsspezifischer Unterschied festgestellt werden, hingegen wurde für verheiratete Männer, im Gegensatz zu verheirateten Frauen, ein höheres Einkommen als gerecht eingestuft. Die Befragten gewähren den Männern also eine "Heiratsprämie".\\
