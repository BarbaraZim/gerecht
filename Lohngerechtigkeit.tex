...
\comment{diesen Abschnitt weglassen? Ist für unsere Exp. nicht relevant.}
Die Entlohnung von Tätigkeiten bemisst sich nicht nur daran, welche Fähigkeiten
zu ihrer Ausübung nötig sind, sondern auch an den Arbeitsbedingungen (z.B. wie
interessant, anstrengend oder gefährlich eine Tätigkeit ist). Dieser
theoretische Ansatz, „compensating differentials“ genannt
\citep{Kilbourne-etal-1994}, besagt, dass ein Teil des Lohnunterschieds
zwischen Frauen und Männern darauf zurückgeführt werden kann, dass Männer
unangenehmere Jobs ausüben und deshalb höher entlöhnt würden. Überzeugende
Evidenz, dass die „compensating differentials“ einen substanziellen Teil der
geschlechtsspezifischen Lohndifferenz erklären, gibt es allerdings kaum.
\comment{vgl.
Goldin, 2014, im Zusammenhang mit zeitlicher Flexibilität --> Goldin bewegt sich da auf sehr dünnem Eis (Kommentare in ihrem Artikel}
\comment{Stimmt die Behauptung im letzten Satz? --> ich finde jedenfalls nur Artikel, die diese These widerlegen, aber keine die sie bestätigen, z.B. McCrate 2005, Kilbourne et al 1994 oder Palme \& Wright 2006 (nicht online)}
...
Beckers „Economics of Discrimination“ \citep{Becker-1973}. \comment{überarbeiten!}Unter Annahme
rationalen Verhaltens der Akteure erfolgt Diskriminierung aufgrund von
Vorurteilen gegenüber bestimmten Gruppen („taste-based discrimination“). Ein
zentrales Argument ist, dass beispielsweise Frauen oder Schwarze deswegen
diskriminiert werden, weil dem/der ArbeitgeberIn sonst Nachteile erwachsen
würden, zum Beispiel durch ein schlechteres Betriebsklima, Umsatzeinbussen oder
den Verlust von KundInnen. Die Antizipierung dieser möglichen Nachteile kann
dazu führen, dass diese kompensiert werden, indem Frauen weniger Lohn erhalten,
in bestimmten Positionen nicht angestellt werden oder indem ihnen in gewissen
Positionen weniger Aufstiegschancen gewährt werden.
...
an statistischen Gruppenmerkmalen orientieren. Diese Theorie kann
Lohnungleichheiten zwischen den Geschlechtern im Prinzip nur erklären, wenn
sich die Produktivität der beiden Geschlechter unterscheidet. Soziologische und
...
\comment{diesen Abschnitt weglassen, da für unsere Exp. nicht relevant(?)}
Was die neoklassischen Ansätze der Arbeitsmarktforschung weitgehend ausser Acht
lassen, ist der Umstand, dass auf dem Arbeitsmarkt nicht alle Akteure zwingend
gleich viel Macht besitzen und infolgedessen einen unterschiedlich grossen
Handlungsspielraum haben \citep[40]{Abraham-Hinz-2005}. In diese Richtung geht
zum Beispiel der Ansatz der monopsonistischen Diskriminierung: Demnach ist das
Arbeitsangebot von Frauen weniger lohnelastisch, was Unternehmen mehr
Verhandlungsmacht gibt, womit sie Frauen tiefere Löhne bezahlen können. Gründe
für die Geschlechterunterschiede in der Lohnelastizität sind, dass Frauen (z.B.
aufgrund von familiären Verpflichtungen) weniger mobil und eher auf
Teilzeitarbeit angewiesen sind, oder dass die Job-Auswahl für sie kleiner ist,
da sie sich auf weniger Berufe konzentrieren (z.B.
\citealp{Hirsch-etal-2010,Webber-2016}).

Schliesslich haben gemäss der „status construction theory“
\citep{Ridgeway-1997,Ridgeway-2001} bereits existierende Status- und
